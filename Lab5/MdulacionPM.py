...
class MdulacionPM(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "Mdulacion PM", catch_exceptions=True)
        ...
        self._GTX_win = RangeWidget(self._GTX_range, self.set_GTX, "Ganacia trasmisor", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._GTX_win)
        self._Am_range = Range(0, 10, 0.000001, 1, 200)
