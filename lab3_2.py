...
class lab3_2(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "lab3_2")
        ...
        # Variables
        ##################################################
        self.samp_rate = samp_rate = 17.568e5
        self.A = A = 1

        ##################################################
        # Blocks
        ##################################################
        self._A_range = Range(0, 25, 1, 1, 200)
        self._A_win = RangeWidget(self._A_range, self.set_A, 'Amplitud señal', "counter_slider", float)
        ...
        self.analog_sig_source_x_0_0 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, 17.568e4, A, 0, 0)
        self.analog_sig_source_x_0 = analog.sig_source_f(samp_rate, analog.GR_SAW_WAVE, 5800, A, 0, 0)
        ...
        self.connect((self.blocks_multiply_xx_0, 0), (self.CalculoPotenciaComunicaciones_0, 0))
