...
from Modulador_AM_D1B import Modulador_AM_D1B  # grc-generated hier_block
...
class Trasmisor_AM(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Trasmisor_AM")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Trasmisor_AM")
        ...
        self.settings = Qt.QSettings("GNU Radio", "Trasmisor_AM")
        ...
        self._Ka_range = Range(0, 2, 0.001, 1, 200)
        ...
        self._GTX_win = RangeWidget(self._GTX_range, self.set_GTX, 'GTX', "counter_slider", float)
        self.top_layout.addWidget(self._GTX_win)
        self._Ac_range = Range(0, 1, 0.001, 0.2, 200)
        ...
        self.Modulador_AM_D1B_0 = Modulador_AM_D1B(
            Ac=Ac,
            kA=Ka,
        )
        ...
        # Connections
        ##################################################
        self.connect((self.Modulador_AM_D1B_0, 0), (self.blocks_complex_to_real_0, 0))
        self.connect((self.Modulador_AM_D1B_0, 0), (self.qtgui_time_sink_x_0, 0))
        self.connect((self.Modulador_AM_D1B_0, 0), (self.uhd_usrp_sink_0, 0))
        self.connect((self.analog_sig_source_x_0, 0), (self.Modulador_AM_D1B_0, 0))
    ...
    def set_Ka(self, Ka):
        self.Ka = Ka
        self.Modulador_AM_D1B_0.set_kA(self.Ka)
    ...
    def set_Ac(self, Ac):
        self.Ac = Ac
        self.Modulador_AM_D1B_0.set_Ac(self.Ac)





def main(top_block_cls=Trasmisor_AM, options=None):
